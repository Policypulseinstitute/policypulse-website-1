...
function BackgroundImageComponent({ image}) {
  ...
  return (
    <div style={backgroundImageStyle}  className="background-image-container">
      ...
      <p className="info-text">At <span className="highlighted" style={{ fontFamily: 'Futura, sans-serif' }}>Policy Pulse</span> we build bridges between cutting-edge academic research and real-world implementation by supporting policymakers with evidence-based solutions to complex issues.</p>
      <p className="info-text">At <span className="highlighted" style={{ fontFamily: 'Futura, sans-serif' }}>Policy Pulse</span> we are an experienced team that brings together a unique blend of global policy expertise and frontier research, with comprehensive know-how in <span className="highlighted-other">policy development and evaluation, data analytics, and political advisory services.</span></p>
    </div>
  );
}
