...
function BackgroundComponent() {
  ...
  return (
    <div className="background-container">
      ...
      <p className="info-text"> <span className="highlighted" style={fontStyle}>Policy Pulse</span> is a knowledge-for-policy institute working in partnership with organisations and governments to provide research and advisory services.  XXXX</p>
