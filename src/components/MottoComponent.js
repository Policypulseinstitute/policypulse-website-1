  ...
  return (
    <div className='motto-container'>
      ...
      <p className='motto-explanation'> 
        ...
        <br /> {/* Added Line Break */}
        It conveys our commitment to prioritizing wisdom and discernment in our advice and recommandations, reflecting our pursuit of excellence and thoughtful consideration in all we do.
      </p>
    </div>
  );
}
