...
function InfoComponent() {
  return (
    <div className='info-container'>
      ...
      <p className="info-text"><span className="highlighted" style={{ fontFamily: 'Futura, sans-serif' }}>Policy Pulse</span> is a XYSYSYSXX knowledge-for-policy institute working in partnership with organisations and governments to provide research and advisory services.</p>
